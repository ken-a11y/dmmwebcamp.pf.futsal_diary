...
ActiveRecord::Schema.define(version: 2022_07_03_041430) do
  ...
  create_table "tactic_items", force: :cascade do |t|
  ...
  create_table "tactic_tags", force: :cascade do |t|
    t.integer "diary_id"
    t.integer "tag_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
